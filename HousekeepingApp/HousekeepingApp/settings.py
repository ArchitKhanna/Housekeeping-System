"""
Django settings for HousekeepingApp project.
...
INSTALLED_APPS = [
    ...
    'HKmanager.apps.HkmanagerConfig',
...
ROOT_URLCONF = 'HousekeepingApp.urls'
...
WSGI_APPLICATION = 'HousekeepingApp.wsgi.application'
